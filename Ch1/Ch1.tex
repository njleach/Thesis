...
\section{The 2018 heatwave in Europe}
  ...
  \begin{figure}[h]
    ...
    \caption[The 2018 heatwave in Europe: observed mean temperature anomalies over a range of timescales]{\textbf{The 2018 heatwave in Europe: observed mean temperature anomalies over a range of timescales.} }
    \label{fig2.1}
  \end{figure}
  % \clearpage
...
%This needs a re-write
  ...
  \begin{figure}[h]
    ...
    \caption[Calculating the heatwave threshold in HadGEM3-A from observations]{\textbf{Calculating the heatwave threshold in HadGEM3-A from observations.} }
    \label{fig2.2}
  \end{figure}
  % \clearpage
  ...
  \begin{figure}[h]
    ...
    \caption[Factual and counterfactual PDFs of the 2018 heatwave defined over three temporal scales]{\textbf{Factual and counterfactual PDFs of the 2018 heatwave defined over three temporal scales.} }
    \label{fig2.3}
  \end{figure}
  % \clearpage
...
\section{Results}
  ...
  \begin{figure}[h]
    ...
    \caption[Maps of the estimated change in probability of the 2018 heatwave due to anthropogenic influence on the climate]{\textbf{Maps of the estimated change in probability of the 2018 heatwave due to anthropogenic influence on the climate.} }
    \label{fig2.4}
  \end{figure}
  % \clearpage
  ...
  \begin{figure}[h]
    ...
    \caption[Estimated changes in probability of the 2018 heatwave defined using regional mean temperatures]{\textbf{Estimated changes in probability of the 2018 heatwave defined using regional mean temperatures.} }
    \label{fig2.5}
  \end{figure}
  % \clearpage
  ...
  \begin{figure}[h]
    ...
    \caption[Estimated changes in probability of the 2018 British Isles heatwave across a range of observations and model simulations]{\textbf{Estimated changes in probability of the 2018 British Isles heatwave across a range of observations and model simulations.} }
    \label{fig2.6}
  \end{figure}
  % \clearpage
  ...
  \begin{figure}[h]
    ...
    \caption[Historical power spectrum of summer daily mean temperatures over the British Isles across a range of observations and model simulations]{\textbf{Historical power spectrum of summer daily mean temperatures over the British Isles across a range of observations and model simulations.} }
    \label{fig2.7}
  \end{figure}
  % \clearpage
