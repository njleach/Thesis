...
\section{Results}\label{ch2:results}
  ...
  \begin{figure}[h]
    ...
    \caption[Estimated changes in probability of the 2018 British Isles heatwave across a range of observations and model simulations]{\textbf{Estimated changes in probability of the 2018 British Isles heatwave across a range of observations and model simulations.} Here, probability ratios are estimated using a trend-based analysis. Colour indicates data source. Dots indicate central probability ratio estimate and bars indicate 90\% confidence interval.}
    \label{fig2.6}
  \end{figure}
  % \clearpage
